...
{
    public class WorkbookExcelRender
    {
        /// <summary>
        /// The workbook.
        /// </summary>
        ...
        public WorkbookExcelRender BuildWorksheet(string sheetName, short numberOfColumns, short singleRowHeight = 13, bool displayGridlines = false)
        {
