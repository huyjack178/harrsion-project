namespace Fanex.BetList.Core.UnitTest.Builder.ChoiceBuilder
{
    ...
    /// <summary>
    /// Unit test for Choice23202 class.
    /// </summary>
    [TestFixture]
    public class Choice23202Test
    {
        ...
        public void Setup()
        {
            _choice = new Choice23202();
            _ticket = Substitute.For<ITicket>();
            _ticket.BetTypeId = BetTypes.BingoPending;
        ...
        /// </summary>
        [Test]
        public void BuildBetTeam_HomeIdNotZero_BetTeamAreBingoPendingResource()
        {
            // Act
            _choice.Render(_ticket, _ticketHelper, null, Arg.Any<bool>());

            // Assert
            string expectedBetTeam = string.Format("{0} - {1}", CoreBetList.bingo, CoreBetList.pending);
