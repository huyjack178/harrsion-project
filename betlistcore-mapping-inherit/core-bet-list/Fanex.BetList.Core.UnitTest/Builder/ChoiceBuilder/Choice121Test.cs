namespace Fanex.BetList.Core.UnitTest.Builder.ChoiceBuilder
{
    ...
    /// <summary>
    /// Unit test for Choice121 class.
    /// </summary>
    [TestFixture]
    public class Choice121Test
    {
        ...
        public void Setup()
        {
            _choice = new Choice121();
            _ticket = Substitute.For<ITicket>();
            _ticket.BetTypeId = BetTypes.Home_No_Bet;
        ...
        /// <summary>
        /// The value of Template.betTeam is always Draw when bet team of ticket contains character x.
        /// </summary>
        [Test]
        public void BuildBetTeam_BetTeamContainsCharacterX_BetTeamIsDrawResource()
        {
            // Arrange
            _ticket.BetTeam = "text x";
        ...
        /// <summary>
        /// The value of Template.betTeam is always Template.Match.awayTeam when bet team of ticket is null.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// The value of Template.betTeam is always Template.Match.awayTeam when bet team of ticket is empty or not contains character h.
        /// </summary>
        [Test]
