namespace Fanex.BetList.Core.UnitTest.Builder.ChoiceBuilder
{
    ...
    /// <summary>
    /// Unit test for Choice23001 class.
    /// </summary>
    [TestFixture]
    public class Choice23001Test
    {
        ...
        public void Setup()
        {
            _choice = new Choice23001();
            _ticket = Substitute.For<ITicket>();
            _ticket.BetTypeId = BetTypes.CasinoTransfer;
        ...
        /// <summary>
        /// The value of Template.betTeam is always Casino -  Transfer.
        /// </summary>
        [Test]
        public void BuildBetTeam_HomeIdNotZero_BetTeamAreCasinoTrasferResource()
        {
            // Act
            _choice.Render(_ticket, _ticketHelper, null, Arg.Any<bool>());

            // Assert
            string expectedBetTeam = string.Format("{0} - {1}", CoreBetList.casinoGame, CoreBetList.transfer);
