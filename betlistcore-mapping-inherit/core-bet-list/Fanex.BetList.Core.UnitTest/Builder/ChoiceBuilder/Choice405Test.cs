namespace Fanex.BetList.Core.UnitTest.Builder.ChoiceBuilder
{
    ...
    public class Choice405Test
    {
        ...
        public void Setup()
        {
            _choice = new Choice405();
            _ticket = Substitute.For<ITicket>();
            _ticket.BetTypeId = BetTypes._2HCorrectScore;
            _ticketHelper = Substitute.For<ITicketHelper>();
        }

        /// <summary>
        /// The value of Template.betTeam is AOS when ticket.BetTeam is AOS or aos.
        /// </summary>
        [TestCase("AOS")]
        [TestCase("aos")]
        ...
        /// </summary>
        [Test]
        public void BuildChoice_BetTeamIsNotAOS_BetTeamAreSpaceAndBetTeam()
        {
            // Arrange
        ...
        [Test]
        public void BuildBetType_Always_ShowBetTypeNameFromRemotingRef()
        {
            // Arrange.
            _ticketHelper.GetBetTypeNameById(405).Returns("Bet Type Name");

            // Act
            _choice.Render(_ticket, _ticketHelper, null, false);

            // Assert
            string expectedBetTypeName = "Bet Type Name";
